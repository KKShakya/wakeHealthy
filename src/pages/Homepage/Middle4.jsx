  ...
  return (
    ...
    <div className="middle4_parent">
      ...
      <div className="middle4-box2">
        ...
        <div>
          <img
            src="https://cdn-images.cure.fit/www-curefit-com/image/upload/c_fill,w_150,ar_0.79,q_auto:eco,dpr_2,f_auto,fl_progressive/image/test/trainer-parallax/tile-7.png"
            alt=""
          />
        </div>
        <div>
          <img
            src="https://cdn-images.cure.fit/www-curefit-com/image/upload/c_fill,w_150,ar_0.79,q_auto:eco,dpr_2,f_auto,fl_progressive/image/test/trainer-parallax/tile-8.png"
            alt=""
          />
        </div>
      </div>
    ...
    className="content3">
      <div data-aos="zoom-out" >
      <h1>Fun, trainer led group classes</h1>
      </div>
    </div>
    </div>
